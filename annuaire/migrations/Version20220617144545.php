 ...
 */
final class Version20220617144545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, auteur_id INTEGER DEFAULT NULL, categorie_id INTEGER DEFAULT NULL, image_id INTEGER DEFAULT NULL, titre VARCHAR(200) NOT NULL, contenu CLOB NOT NULL, CONSTRAINT FK_23A0E6660BB6FE6 FOREIGN KEY (auteur_id) REFERENCES auteur (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_23A0E66BCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_23A0E663DA5256D FOREIGN KEY (image_id) REFERENCES image (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__auteur AS SELECT id, image_id, nom, role, actif FROM auteur');
        ...
        $this->addSql('INSERT INTO auteur (id, image_id, nom, role, actif) SELECT id, image_id, nom, role, actif FROM __temp__auteur');
        ...
        $this->addSql('INSERT INTO image (id, url) SELECT id, url FROM __temp__image');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__auteur AS SELECT id, image_id, nom, role, actif FROM auteur');
        $this->addSql('DROP TABLE auteur');
        $this->addSql('CREATE TABLE auteur (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, image_id INTEGER DEFAULT NULL, nom VARCHAR(30) NOT NULL, role VARCHAR(10) NOT NULL, actif BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO auteur (id, image_id, nom, role, actif) SELECT id, image_id, nom, role, actif FROM __temp__auteur');
        $this->addSql('DROP TABLE __temp__auteur');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_55AB1403DA5256D ON auteur (image_id)');
        $this->addSql('DROP INDEX IDX_67F068BC7294869C');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__image AS SELECT id, url FROM image');
        $this->addSql('DROP TABLE image');
        $this->addSql('CREATE TABLE image (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, url VARCHAR(255) NOT NULL, article_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO image (id, url) SELECT id, url FROM __temp__image');
        $this->addSql('DROP TABLE __temp__image');
